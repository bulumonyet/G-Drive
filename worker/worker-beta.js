...
const uiConfig = {
	...
	"version": "2.0.7", // don't touch this one. get latest code using generator at https://github.com/bulumonyet/G-Drive
	"logo_image": false, // true if you're using image link in next option.
	"logo_height": "", // only if logo_image is true
	"logo_width": "100px", // only if logo_image is true
	"logo_link_name": "G-Drive Index", // if logo is true then link otherwise just text for name
